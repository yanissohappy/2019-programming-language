	...
	(defvar y 0)
	(defvar end_mark 0)
	(defvar first_enter_in_1 1)
	(defvar first_enter_in_2 1)
...
(if	(> the_same_counter 0)
	(loop 
				...
				(loop
					...
					(if (= the_same_counter_copy 0)
						(loop 
							(setq nth_line1(nth x list1))	
							(setq nth_line2(nth y list2))
							(cond ((and (> counter1 counter2) (= y (- counter2 1))(/= x (- counter1 1))) (loop 
										(if (= first_enter_in_1 1)(format t "~C[32m+~a~%~C[00m" #\ESC nth_line2 #\ESC))
										(setq first_enter_in_1 0)
										(setq nth_line1(nth x list1))
								...
								((and (< counter1 counter2) (= x (- counter1 1))(/= y (- counter2 1))) (loop 
										(if (= first_enter_in_1 1)(format t "~C[31m-~a~%~C[00m" #\ESC nth_line1 #\ESC))
										(setq first_enter_in_1 0)			
										(setq nth_line2(nth y list2))
								...
								((and (= x (- counter1 1)) (= y (- counter2 1))(= x y))
									(format t "~C[31m-~a~%~C[00m" #\ESC nth_line1 #\ESC)
									(format t "~C[32m+~a~%~C[00m" #\ESC nth_line2 #\ESC)	
									(cl-user::quit)				
									)				
							...
							(if (and (= x (- counter1 1)) (= y (- counter2 1))(/= x y)) (cl-user::quit))
		...
		(if (and (equal y (- counter2 1))(= found 0))
			(format t "~C[31m-~a~%~C[00m" #\ESC nth_line1 #\ESC)		
		)
		(setq found 0)
		(setq y keyline)
...
(if	(= the_same_counter 0)
	(loop 
		...
		(setq nth_line2(nth y list2))
		(cond ((and (> counter1 counter2) (= y (- counter2 1))(/= x (- counter1 1))) (loop 
					(if (= first_enter_in_2 1)(format t "~C[32m+~a~%~C[00m" #\ESC nth_line2 #\ESC))
					(setq first_enter_in_2 0)
					(setq nth_line1(nth x list1))
					(format t "~C[31m-~a~%~C[00m" #\ESC nth_line1 #\ESC)
					(if (equal x (- counter1 1)) (return nil))
					(setq x (+ 1 x))
			...
			((and (< counter1 counter2) (= x (- counter1 1))(/= y (- counter2 1))) (loop 
					(if (= first_enter_in_2 1)(format t "~C[31m-~a~%~C[00m" #\ESC nth_line1 #\ESC))
					(setq first_enter_in_2 0)			
					(setq nth_line2(nth y list2))
					(format t "~C[32m+~a~%~C[00m" #\ESC nth_line2 #\ESC)
					(if (equal y (- counter2 1)) (return nil))
